...
export function BuyerOffersEmptyState() {
  return (
    <div className="flex min-h-[420px] flex-col items-start justify-center border border-dashed border-black/20 bg-white p-8 md:p-12">
      <p className="text-xs uppercase tracking-[0.25em] text-black/40">Property Offers</p>
      ...
      <p className="mt-5 max-w-xl text-sm leading-7 text-black/55">
        Offers submitted for properties you are interested in will appear here, together with their
