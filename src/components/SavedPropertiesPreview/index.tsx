  ...
  return (
    <section className="mt-16">
      <div className="mb-6 flex items-end justify-between">
        <div>
          <p className="text-sm uppercase tracking-[0.25em] text-muted-foreground">Favourites</p>

          <h2 className="mt-2 text-3xl font-medium">Saved Properties</h2>
        </div>

        <Link href="/saved" className="border px-4 py-2 text-sm">
          View All
        </Link>
      </div>
